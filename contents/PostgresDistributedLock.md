...
## Postgres Distributed Lock Package

* **Paramore.Brighter.Locking.PostgresSql**

Advisory locks are a built-in PostgreSQL feature, so there is **no table to provision** —
see [Provisioning](#postgres-distributed-lock-provisioning).

## Postgres Distributed Lock Configuration
...
## Postgres Distributed Lock Provisioning
...
## Postgres Distributed Lock Notes
