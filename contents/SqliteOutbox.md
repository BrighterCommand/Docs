...
- Use `SqliteTransactionProvider` for ADO.NET-based transaction management.
- Use `SqliteEntityFrameworkTransactionProvider<T>` if you are using Entity Framework Core, where `T` is your `DbContext`.
